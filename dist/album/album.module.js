...
AlbumModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([album_entity_1.default, song_entity_1.default])],
        controllers: [album_controller_1.default],
        providers: [album_service_1.default, songs_service_1.default],
    })
], AlbumModule);
